...
export class CreateBarbershopDto {
  ...
  @ApiProperty({ example: 'Best barbershop in town' }) @IsString() description!: string;
  ...
  @ApiPropertyOptional({ example: '0123456789' }) @IsOptional() @IsString() phoneNumber?: string;
  @ApiPropertyOptional({ example: 'https://cdn/logo.png' }) @IsOptional() @IsString() logo?: string;
